...
impl StandardSchema for String {
    type Input = String;
    type Output = String;
...
impl StandardSchema for NonEmptyString {
    type Input = String;
...
impl<const N: usize> StandardSchema for MinLengthString<N> {
    type Input = String;
...
impl<const N: usize> StandardSchema for MaxLengthString<N> {
    type Input = String;
