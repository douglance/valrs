...
///
/// impl StandardSchema for PositiveInt {
///     type Input = i64;
...
/// }
/// ```
pub trait StandardSchema: Sized {
    ...
    const VENDOR: &'static str = "standard-schema-rs";
...
pub trait StandardJsonSchema: StandardSchema {
