...
//!
//! ```javascript
//! import { validate_string, validate_i32 } from 'standard-schema-wasm';
//!
...
//!
//! ```javascript
//! import { string_json_schema, i32_json_schema } from 'standard-schema-wasm';
//!
...
//!
//! ```javascript
//! import { SchemaRegistry } from 'standard-schema-wasm';
//!
...
use standard_schema::{
    JsonSchemaTarget, StandardJsonSchema, StandardSchema, ValidationIssue, ValidationResult,
};
...
mod wasm_tests {
    ...
    fn wasm_test_vendor_and_version() {
        assert_eq!(vendor(), "standard-schema-rs");
        assert_eq!(version(), 1);
    }
}
