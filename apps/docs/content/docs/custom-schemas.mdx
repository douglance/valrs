...
description: Extend validators with refinements, transforms, and preprocessing. While valrs provides built-in primitive validators, you'll often need to add custom constraints, transform values, or preprocess input.
---
