...
export interface StandardSchemaV1<Input = unknown, Output = Input> {
    ...
    readonly '~standard': {
        ...
        readonly validate: (value: unknown) => ValidationResult<Output> | Promise<ValidationResult<Output>>;
    };
}
/**
 ...
 * @template Output - The validated output type (defaults to Input)
 */
export interface StandardJSONSchemaV1<Input = unknown, Output = Input> extends StandardSchemaV1<Input, Output> {
 ...
 */
export type InferInput<T extends StandardSchemaV1> = T extends StandardSchemaV1<infer I, unknown> ? I : never;
/**
 * Infers the output type from a Standard Schema.
 */
export type InferOutput<T extends StandardSchemaV1> = T extends StandardSchemaV1<unknown, infer O> ? O : never;
/**
 * Type guard to check if a validation result is successful.
 */
export declare function isValidationSuccess<T>(result: ValidationResult<T>): result is {
    readonly value: T;
    readonly issues?: undefined;
};
/**
 ...
 */
export declare function isValidationFailure<T>(result: ValidationResult<T>): result is {
    readonly issues: ReadonlyArray<ValidationIssue>;
    readonly value?: undefined;
};
